      ...
      <div className="glass-panel p-6 rounded-3xl">
        <div className="flex flex-col md:flex-row gap-4 md:items-end">
          <div className="space-y-1">
            <label htmlFor="progress-date" className="text-xs text-slate-500 block font-semibold">تاریخ *</label>
            <input
              id="progress-date"
              type="date"
              ...
              aria-required="true"
              aria-label="تاریخ ثبت پیشرفت"
            />
          </div>
          <div className="space-y-1">
            <label htmlFor="progress-weight" className="text-xs text-slate-500 block font-semibold">وزن (kg) *</label>
            <input
              id="progress-weight"
              type="number"
              className="input-glass"
          ...
          <div className="space-y-1">
            <label htmlFor="progress-bf" className="text-xs text-slate-500 block font-semibold">درصد چربی بدن (اختیاری)</label>
            <input
              id="progress-bf"
              type="number"
              className="input-glass"
          ...
          <div className="flex-1 space-y-1">
            <label htmlFor="progress-note" className="text-xs text-slate-500 block font-semibold">یادداشت کوتاه</label>
            <input
              id="progress-note"
              type="text"
              className="input-glass"
