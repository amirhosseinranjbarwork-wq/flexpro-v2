      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          <h2 className="text-3xl md:text-5xl font-bold text-slate-900 dark:text-white mb-6">
            Stop Guessing. <span className="text-blue-600 dark:text-blue-400">Start Engineering.</span>
          </h2>
          <p className="text-lg text-slate-600 dark:text-slate-400 max-w-2xl mx-auto">
            See why elite coaches are switching from static spreadsheets to dynamic programming.
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
          ...
          <div className="p-8 rounded-2xl bg-slate-50 dark:bg-slate-900/30 border border-slate-200 dark:border-slate-800">
            <div className="flex items-center gap-3 mb-6">
              ...
              <h3 className="text-xl font-bold text-slate-600 dark:text-slate-400">The Old Way</h3>
            </div>
            <ul className="space-y-4">
              {['Static PDF/Excel sheets', 'Manual volume calculations', 'Guessing weights & RPE', 'No real-time feedback loop', 'Disorganized progress photos'].map((item) => (
          ...
          <div className="relative p-8 rounded-2xl bg-gradient-to-b from-blue-50 to-white dark:from-slate-800 dark:to-slate-900 border-2 border-blue-500 shadow-xl scale-105">
            ...
            <div className="flex items-center gap-3 mb-6">
              ...
              <h3 className="text-xl font-bold text-slate-900 dark:text-white">The ProCoach Way</h3>
            </div>
            <ul className="space-y-4">
              {['Dynamic, AI-assisted adjustments', 'Auto-calculated Volume & Intensity', 'Precise RPE & Tempo targets', 'Instant client feedback analytics', 'Secure, private gallery tracking'].map((item) => (
