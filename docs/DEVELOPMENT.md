...
### **گزینه ۱: راه‌اندازی کامل اتوماتیک (توصیه شده)**
...
# راه‌اندازی کامل اتوماتیک (Git + DB + Server)
npm run dev:sync
```

### **گزینه ۲: راه‌اندازی دستی**
...
فایل `scripts/env.example` را کپی کرده و به `.env` تغییر نام دهید:
